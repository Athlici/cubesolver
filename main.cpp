...
cout << "edgedepth: " << readhalfbyte(*(edges+address[0]/2),address[0]&1)+0 << "; cornerdepths: " << readhalfbyte(*(edges+address[1]/2),address[1]&1)+0 << ";" << readhalfbyte(*(edges+address[2]/2),address[2]&1)+0 << ";" << readhalfbyte(*(edges+address[3]/2),address[3]&1)+0 << ";" << readhalfbyte(*(edges+address[4]/2),address[4]&1)+0 << "; centerdepths: " << readhalfbyte(*(edges+address[5]/2),address[5]&1)+0 << ";" << readhalfbyte(*(edges+address[6]/2),address[6]&1)+0 << ";" << readhalfbyte(*(edges+address[7]/2),address[7]&1)+0 << "\n";
