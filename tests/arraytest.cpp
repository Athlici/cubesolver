...
int main(int argc, char** argv) {
  ...
  for (int i=0;i<36;i++){
    ...
    for (int j=0;j<24;j++){
      if (full[cornermove[i][j]]) cout << "Doubbel Numb3r in line " << i+0 << "\n";
  ...
  for (int i=0;i<36;i++){
    for (int j=0;j<24;j++) full[j]=false;
    for (int j=0;j<24;j++){
      if (full[centermove[i][j]]) cout << "Doubbel Numb3r in line " << i+0 << "\n";
  ...
  for (int i=0;i<18;i++){
    for (int j=0;j<24;j++) full[j]=false;
    for (int j=0;j<24;j++){
      if (full[edgemove[i][j]]) cout << "Doubbel Numb3r in line " << i+0 << "\n";
  ...
  for (int i=0;i<23;i++){
    for (int j=0;j<24;j++) full[j]=false;
    for (int j=0;j<24;j++){
      if (full[centerturn[i][j]]) cout << "Doubbel Numb3r in line " << i+0 << "\n";
  ...
  for (int i=0;i<23;i++){
    for (int j=0;j<24;j++) full[j]=false;
    for (int j=0;j<24;j++){
      if (full[cornerturn[i][j]]) cout << "Doubbel Numb3r in line " << i+0 << "\n";
