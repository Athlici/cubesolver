...
//cout << add+0 << ":" << ((adr>>48)&255)+0 << ";" << ((adr>>40)&255)+0 << ";" << ((adr>>32)&255)+0 << ";" << ((adr>>24)&255)+0 << ";" << ((adr>>16)&255)+0 << ";" << ((adr>>8)&255)+0 << ";" << (adr&255)+0 << "\n";
...
//cout << j+0 << ":" << edgemove[i][(adr>>48)&255]+0 << ";" << edgemove[i][(adr>>40)&255]+0 << ";" << edgemove[i][(adr>>32)&255]+0 << ";" << edgemove[i][(adr>>24)&255]+0 
//     << ";" << edgemove[i][(adr>>16)&255]+0 << ";" << edgemove[i][(adr>>8)&255]+0 << ";" << edgemove[i][adr&255]+0 << ":" << readhalfbyte(~table[k][j/2],j%2)+0 << "\n";
...
cout << mover+0 << "-" << j+0 << ":" << centermove[i][(adr>>56)&255]+0 << ";" << centermove[i][(adr>>48)&255]+0 << ";" << centermove[i][(adr>>40)&255]+0 << ";" << centermove[i][(adr>>32)&255]+0 << ";" << centermove[i][(adr>>24)&255]+0 << ";" << centermove[i][(adr>>16)&255]+0 << ";" << centermove[i][(adr>>8)&255]+0 << ";" << centermove[i][adr&255]+0 << "\n";
